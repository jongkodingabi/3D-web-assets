...
export default function Service() {
  ...
  return (
    <section
      id="service"
      className="section flex items-center justify-center flex-col"
    >
      <h2 className="section-title text-white font-bold text-4xl mb-4">
        Our things
      </h2>
      <p className="section-subtitle text-gray-400 mb-12 text-center px-10 max-w-5xl mx-auto">
      ...
      <div className="grid grid-cols-4 grid-rows-5 gap-4 w-full px-50">
        ...
        <motion.div
          ...
          className="col-span-4 row-span-3 w-full h-[400px] border-4 border-purple-500 hover:border-8 transition-all rounded-2xl overflow-hidden relative group"
          ref={mountRef}
        >
        ...
        {mockData.map((model, index) => (
          <motion.div
            ...
            className={`row-span-2 row-start-4 w-full h-[150px] bg-zinc-900 p-0 rounded-2xl border-4 cursor-pointer transition-all duration-300 ${
